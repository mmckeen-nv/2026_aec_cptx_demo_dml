...
declare -x AUXILIARY_APPROVAL_MODEL="azure/anthropic/claude-opus-4-6"
declare -x AUXILIARY_APPROVAL_PROVIDER="custom"
...
declare -x AUXILIARY_WEB_EXTRACT_MODEL="azure/anthropic/claude-opus-4-6"
declare -x AUXILIARY_WEB_EXTRACT_PROVIDER="custom"
...
declare -x DML_DIR="/c/Users/test/AppData/Local/hermes/integrations/daystrom-dml"
declare -x DRIVERDATA="C:\\Windows\\System32\\Drivers\\DriverData"
declare -x EDITOR="notepad"
declare -x EFC_7852="1"
...
declare -x HERMES_SESSION_ID="20260702_142924_7f4e58"
