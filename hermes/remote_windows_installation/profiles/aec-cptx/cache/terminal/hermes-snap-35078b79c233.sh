...
declare -x AUXILIARY_APPROVAL_BASE_URL="https://inference-api.nvidia.com/v1"
declare -x AUXILIARY_APPROVAL_MODEL="nvidia/zai-org/glm-5.2"
declare -x AUXILIARY_APPROVAL_PROVIDER="custom:nvidia"
declare -x AUXILIARY_VISION_BASE_URL="https://inference-api.nvidia.com/v1"
declare -x AUXILIARY_VISION_MODEL="nvidia/zai-org/glm-5.2"
declare -x AUXILIARY_VISION_PROVIDER="custom:nvidia"
declare -x AUXILIARY_WEB_EXTRACT_BASE_URL="https://inference-api.nvidia.com/v1"
declare -x AUXILIARY_WEB_EXTRACT_MODEL="nvidia/zai-org/glm-5.2"
declare -x AUXILIARY_WEB_EXTRACT_PROVIDER="custom:nvidia"
...
declare -x HERMES_SESSION_ID="20260630_070812_1d2cc4"
declare -x HERMES_VLLM_NEMOTRON_API_KEY="local-dev-key"
...
declare -x OLDPWD="/c/Users/test/AppData/Local/hermes/hermes-agent"
...
declare -x PWD="/c/Users/test/AppData/Local/hermes/hermes-agent"
