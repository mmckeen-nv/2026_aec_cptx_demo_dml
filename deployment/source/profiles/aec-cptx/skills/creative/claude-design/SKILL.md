---
name: claude-design
description: "Design one-off HTML artifacts (landing, deck, prototype), throwaway sketch variants, and DESIGN.md token specs."
version: 1.0.0
...
metadata:
  hermes:
    tags: [design, html, prototype, ux, ui, creative, artifact, deck, motion, design-system, sketch, mockup, wireframe, design-md, tokens]
...
- **[Sketch Variants](references/sketch-variants.md)** — When the user wants to *explore* a design direction with 2-3 throwaway HTML mockups before committing. Triggers: "sketch", "mockup", "show me options", "compare designs".
- **[DESIGN.md Token Spec](references/design-md-spec.md)** — Author/validate/export Google's DESIGN.md design token files. Use when the user asks for a DESIGN.md, design tokens, or a machine-readable design system spec. Starter template: [templates/design-md-starter.md](templates/design-md-starter.md).
- **[Popular Web Designs](../popular-web-designs)** — 54 real-world design systems (Stripe, Linear, Vercel) ready for reference.
